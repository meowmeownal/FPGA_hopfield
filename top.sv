...
always_comb begin
    ...
    dac1_raw = (shifted_dac1 * 64'sd975) >>> 26; //hę??? 
...
//always_comb begin
//    shifted_dac1 = $signed(dac1_hold) + 64'sd140929229;
//    dac1_raw = (shifted_dac1 * 64'sd975) >>> 26;
    
//    shifted_dac2 = $signed(dac2_hold) + 64'sd140929229;
//    dac2_raw = (shifted_dac2 * 64'sd975) >>> 26;
//end


//(* mark_debug = "true" *)  logic sample_pending;
...
// logic sample_send_d1;

// always_ff @(posedge CLK100MHZ) begin
//     if(rst)
//         sample_send_d1 <= 0;
//     else
//         sample_send_d1 <= sample_send;
// end
logic dac_pending;
...
i2c_master i2c_inst (
    ...
    .SDA(SDA_in),        // input
    .SCL(SCL_in),        // input
    .SCL_tx_out(SCL_tx_top),  // output -> do IOBUF
    .SDA_tx_out(SDA_tx_top),  // output -> do IOBUF
    .i2c_busy(i2c_busy),
    .data_received(data_received)
);
